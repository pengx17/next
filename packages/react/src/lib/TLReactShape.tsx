import { AnyObject, TLHandle, TLShape, TLShapeWithHandles } from '@tldraw/core'
...
export abstract class TLReactShape<P = any> extends TLShape<P> {
...
> extends TLShapeWithHandles<H, P> {
  abstract ReactComponent: (props: TLComponentProps) => JSX.Element | null
  abstract ReactIndicator: (props: TLIndicatorProps) => JSX.Element | null
}
